...
function addTask() {
    ...
    let rowtask = `<div class="row bg-light rounded-4 ">
                <div class="col">
                    <Label style="font-size: 30px;" for="${taskName}"><pre>${taskName}</pre></Label>
                </div>
                <div class="col">
                    <input type="checkbox" id="${taskName}" name="" style="width: 40px; height: 50px;" >
                </div>
                </div>`
